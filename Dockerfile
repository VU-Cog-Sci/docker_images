...
# Timestamp: 2018-07-23 16:17:11 UTC
# 
...
RUN sed -i '$ijupyter lab --ip 0.0.0.0 --no-browser --config=/home/neuro/.jupyter/jupyter_notebook_config.py' $ND_ENTRYPOINT
...
RUN echo '{ \
    ...
    \n    [ \
    \n      "add_to_entrypoint", \
    \n      "jupyter lab --ip 0.0.0.0 --no-browser --config=/home/neuro/.jupyter/jupyter_notebook_config.py" \
    \n    ], \
    \n    [ \
    \n      "workdir", \
    \n      "/home/neuro" \
